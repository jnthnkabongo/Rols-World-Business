        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 transform transition-all">
            ...
            <form action="{{ route('ajout-produit') }}" method="POST" class="p-6" id="addElectronicsForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <!-- Quantité -->
                    <div>
                        <input type="number" name="devise_id" id="devise_id" hidden value="1">
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 transform transition-all">
            ...
            <form action="{{ route('ajout-produit') }}" method="POST" class="p-6 space-y-4" id="addShoesForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <input type="text" name="numero_serie" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ex: 123456" hidden value="{{ $reference}}">
                    </div>
                    <div>
                        <input type="number" name="devise_id" id="devise_id" hidden value="1">
                    </div>
         ...
         <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 transform transition-all">
            ...
            <form action="{{ route('ajout-produit') }}" method="POST" class="p-6 space-y-4" id="addToolsForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <input type="number" name="devise_id" id="devise_id" hidden value="2">
                    </div>
                </div>
    ...
    <div id="remiseModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 transform transition-all">
            ...
            <form action="{{ route('changer-statut-remise', ['id' => '__id__']) }}" method="POST" class="p-6 space-y-4" id="remiseForm">
                ...
                <div>
                    <label class="bloc texy-sm font-semibold text-gray-700 mb-2" for="">Qauntité produit</label>
                    <input type="number" name="quantite" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ex: 10">
                </div>
                <div class="p-6 border-t border-gray-200 flex justify-end space-x-3">
                    ...
                    <button type="submit" form="remiseForm" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">Mettre en remise</button>
                </div>
            </form>
        </div>
    </div>
